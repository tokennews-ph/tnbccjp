...
$options[] = array( 'name' => _x( '404 page', 'theme-options', 'the7mk2' ), 'type' => 'heading', 'id' => '404-page' );

$options[] = array( 'name' => _x( '404 page template', 'theme-options', 'the7mk2' ), 'type' => 'block' );
